...
const SHOWS = [
  {
    title: "Tribute to Larry Levan and The Paradise Garage - Pt. 5",
    dj: "Omar Abdallah",
  ...
  {
    title: "Larry Levan Live at The Paradise Garage - Closing Night",
    dj: "djmixes",
  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      <p style={{ fontSize: 13, color: "#9a9a9a", marginBottom: 20 }}>
        El espiritu del Paradise Garage: mixes tributo a Larry Levan y a la era del garage house de David Mancuso, via Mixcloud.
      </p>
      ...
      {!isPremium && (
        ...
        >
          <p style={{ fontSize: 16, color: "#f5f5f5", marginBottom: 8 }}>Dandy Radio es una funcion Premium</p>
          <p style={{ fontSize: 13, color: "#9a9a9a", marginBottom: 16 }}>
            Hazte Premium para escuchar la emisora sin limites, ademas de ver perfiles sin limite de distancia.
          </p>
          <a
            href="/settings"
            style={{
        ...
        <div>
          ...
          <div style={{ border: "2px solid #2a2a2a", borderRadius: 8, overflow: "hidden", background: "#171717" }}>
            <div style={{ padding: 14 }}>
              ...
              <p style={{ fontSize: 12, color: "#9a9a9a" }}>{SHOWS[current].dj} - via Mixcloud</p>
            </div>
            <iframe
